...
export default function BuildProcess() {
  ...
  return (
    <section id="process" className="flex flex-col items-center mt-32">
      <p className="font-domine">Simple 8-Step Process</p>
      ...
      <div className="flex flex-col md:flex-row mt-20 md:mt-32">
        ...
        <div className="hidden md:flex flex-col items-center">
          <div className="size-4 bg-gray-300" />
          ...
          {[0, 1, 2].map((i) => (
            <div key={i} className="flex flex-col items-center">
              <div
                ...
                data-index={i}
                className="relative w-0.5 mx-10 h-60 bg-gray-800 overflow-hidden"
              >
                <div
              ...
              <div
                className={`size-4 ${
                  progress[i] > 0.95 ? "bg-gray-800" : "bg-gray-800"
                }`}
              />
            </div>
          ))}
